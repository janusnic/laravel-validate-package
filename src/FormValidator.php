<?php namespace Janusnic\Validation;

use Janusnic\Validation\FactoryInterface as ValidatorFactory;
use Janusnic\Validation\ValidatorInterface as ValidatorInstance;
